...
class PageNewArrival extends Component {
    _isMounted = false;
        ...
        if (totalItems === 0) return (
            <div className="Category">
                ...
                <div className="container barang">
                    <Breadcrumb link={'/new-arrival'} judul={'New Arrival'} linkparents={'/'}/>
                    <div className="row">
                        <Filter />
...
export default connect("baseUrl", actions)(PageNewArrival);
